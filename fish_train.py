...
class YoloTrain(object):
    def __init__(self):
        ...
        self.train_train_logdir  = "./data/log/train"
        ...
        with tf.name_scope('loader_and_saver'):
            ...
            self.saver  = tf.train.Saver(tf.global_variables(), max_to_keep=60)
        ...
        with tf.name_scope('summary'):
            ...
            self.summary_writer = tf.summary.FileWriter(train_logdir, graph=self.sess.graph)
            self.summary_writer_test = tf.summary.FileWriter(test_logdir)
    ...
    def train(self):
        ...
        for epoch in range(1, 1+self.first_stage_epochs+self.second_stage_epochs):
            ...
            for test_data in self.testset:
                summary_test, test_step_loss, global_step_val= self.sess.run(
